...
voltSEPICMax.Value = single(20.4);
voltSEPICMax.Unit = 'V';
...
voltSEPICMin.Value = single(16.8);
voltSEPICMin.Unit = 'V';
...
dcpwmSEPICMax.Value = single(0.95);
